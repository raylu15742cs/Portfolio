         ...
         <div className=" text-center pt-10 lg:mx-[5%]">
            <div className="flex flex-wrap">
                ...
                <div className="pt-7 text-left max-w-[90%] mx-auto mt-2 rounded-lg md:w-[48%] min-[2500px]:w-[24%] md:px-24">
                    <h1 className='text-center pb-5 text-3xl'><a href="https://studibetterfront.onrender.com/" target="#"> StudiBetter </a></h1>
                ...
                <div className="pt-7 text-left max-w-[90%] mx-auto mt-2 rounded-lg md:w-[48%] min-[2500px]:w-[24%] md:px-24">
                    <h1 className='text-center pb-5 text-3xl'><a href="https://raymond.is-a.dev/Beluga-Theme-Store/" target="#"> Yeezy Beluga Theme Store </a></h1>
                ...
                <div className="pt-7 text-left max-w-[90%] mx-auto mt-2 rounded-lg md:w-[48%] min-[2500px]:w-[24%] md:px-24">
                    <h1 className='text-center pb-5 text-3xl'><a href="https://raymond.is-a.dev/Pokemon-Memory-Game/" target="#"> Pokemon Memory Game </a></h1>
