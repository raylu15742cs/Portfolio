    ...
    return (
         <div className="w-[80%] mx-auto text-xs">
            ...
            <div className="">
                ...
                <p className="pt-1">I decided to take the next step and start learning web development on my own. I started with the Odin Project, and I am currently working on the curriculum. I am also working on a Youtube channel where I will be posting videos on my journey. </p>
